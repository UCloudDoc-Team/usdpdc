...
![img](../../images/1.0.x/guide/service/service_yarn.png)
...
![img](../../images/1.0.x/guide/service/service_yarn_details.png)
...
![img](../../images/1.0.x/guide/service/storage_zk.png)
...
![img](../../images/1.0.x/guide/service/storage_zk_details.png)

控制台监控指标可视化支持按时间进行查看，USDP预置了一些时间周期（默认为“1小时内”，还有“6小时内”、“12小时内”、“1天内”、“7天内”、“15天内”、“30天内”），也支持时间周期“自定义”，如下图所示：

![img](../../images/1.0.x/guide/service/storage_zk_details_time.png)
...
![img](../../images/1.0.x/guide/service/storage_hdfs.png)
...
![img](../../images/1.0.x/guide/service/storage_hdfs_details.png)

对HDFS GC相关监控（GC5分钟内的频率、GC耗时、GC MarkSweep标记耗时、GC MarkSweep 5分钟标记频率）如下图所示：

![img](../../images/1.0.x/guide/service/storage_hdfs_details1.png)

对HDFS “堆内存使用大小”的监控，如下图所示：

![img](../../images/1.0.x/guide/service/storage_hdfs_details2.png)
...
![img](../../images/1.0.x/guide/service/storage_hdfs_ui.png)

点击“[udp08] NameNode1 Web UI”/“[udp09] NameNode2 Web UI”，会自动在浏览器中打开新的标签页，并显示udp08/udp09节点上的HDFS管理页面，如下图所示：

![img](../../images/1.0.x/guide/service/storage_hdfs_ui_details.png)
...
![img](../../images/1.0.x/guide/service/service_prometheus.png)
...
![img](../../images/1.0.x/guide/service/service_prometheus_details.png)

![img](../../images/1.0.x/guide/service/service_prometheus_details1.png)
...
![img](../../images/1.0.x/guide/service/service_prometheus_ui.png)

点击“[udp08] Prometheus Graph Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的Prometheus Graph管理页面，如下图所示：

![img](../../images/1.0.x/guide/service/service_prometheus_ui_details.png)

点击“[udp08] Prometheus Targets Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的Prometheus Targets管理页面，如下图所示：

![img](../../images/1.0.x/guide/service/service_prometheus_ui_details1.png)
...
![img](../../images/1.0.x/guide/service/service_grafana.png)
...
![img](../../images/1.0.x/guide/service/service_grafana_details.png)
...
![img](../../images/1.0.x/guide/service/service_grafana_ui.png)
...
![img](../../images/1.0.x/guide/service/service_zkui.png)
...
![img](../../images/1.0.x/guide/service/service_zkui_details.png)
...
![img](../../images/1.0.x/guide/service/service_zkui_ui.png)

点击“[udp08] ZKUI Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的ZKUI登陆管理页面，如下图所示：

![img](../../images/1.0.x/guide/service/service_zkui_ui_details.png)
...
![img](../../images/1.0.x/guide/service/service_configer_zk_update.png)

- 在选择节点对话框中勾选好节点后，点击 <kbd>修改配置</kbd> 按钮进入配置修改页面，如下图所示：

![img](../../images/1.0.x/guide/service/service_configer_zk_update1.png)
...
![img](../../images/1.0.x/guide/service/service_configer_zk_update1_group2.png)

![img](../../images/1.0.x/guide/service/service_configer_zk_update1_group3.png)
...
![img](../../images/1.0.x/guide/service/service_configer_zk_update1_group.png)

图解：将“Log4j.properties”的四个节点的其中两个单独创建一个新分组。

- 此时，分组变为两个，且分组2中包含的节点即为上一步操作选择的两个节点，如下图所示：

![img](../../images/1.0.x/guide/service/service_configer_zk_update1_group0.png)

![img](../../images/1.0.x/guide/service/service_configer_zk_update1_group1.png)
...
![img](../../images/1.0.x/guide/service/service_configer_yarn_update.png)

此时，左侧导航菜单处“YARN”服务后侧出现橙色叹号警示，提醒您执行服务重启生效。且YARN服务“组件管理”中亦有详细提示，如下图所示：

![img](../../images/1.0.x/guide/service/service_configer_yarn_reboot.png)
