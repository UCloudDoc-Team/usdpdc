...
![](../../images/1.0.x/license/license_notification.png)
...
![](../../images/1.0.x/license/20201222105328.png)

- 点击左侧导航栏 <kbd>许可证管理</kbd> 页面右侧即会展示当前USDP的许可证相关的详细信息。如下图所示：

![](../../images/1.0.x/license/20201222105533.png)

- 此时若需要更新许可证，点击右下角的 <kbd>更新许可证</kbd> 按钮，并在下图中 “导入许可证” 对话框中导入新的许可证文件即可。

![](../../images/1.0.x/license/20201222105935.png)