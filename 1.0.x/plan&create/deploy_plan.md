...
| --------- | -------------------------- | -------- | ----------- | ----- | ---- | --------------- | -------------------------- |
| host01    | 8C 32G sys 60GB data 300GB | VPC-M    | Y           | Y     | Y    | USDP Server节点 | 自行规划                   |
| host02    | 4C16G sys 60GB data 200GB  | VPC-C1   | -           | -     | -    | Cluster1-节点1  | 自行规划                   |
| host03    | 4C16G sys 60GB data 200GB  | VPC-C1   | -           | -     | -    | Cluster1-节点2  | 自行规划                   |
| host04    | 4C16G sys 60GB data 200GB  | VPC-C1   | -           | -     | -    | Cluster1-节点3  | 自行规划                   |
| Host05    | 4C16G sys 60GB data 200GB  | VPC-C2   | -           | -     | -    | Cluster2-节点1  | 自行规划                   |
| Host06    | 4C16G sys 60GB data 200GB  | VPC-C2   | -           | -     | -    | Cluster2-节点2  | 自行规划                   |
| Host07    | 4C16G sys 60GB data 200GB  | VPC-C2   | -           | -     | -    | Cluster2-节点3  | 自行规划                   |
