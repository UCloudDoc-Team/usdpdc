...
![img](../../images/1.0.x/developer/airflow/airflow-16061397625039.png)

输入默认设置的用户名和密码  hadoop , hadoop。登录如下界面：

![img](../../images/1.0.x/developer/airflow/airflow-16061401802630.png)
...
![img](../../images/1.0.x/developer/airflow/airflow-16061904173106.png)
