...
![1](../../images/1.0.x/developer/uds/UDS_into.png)

点击 <kbd>Web UIs</kbd> 即可打开当前集群的 UDS 任务管理服务控制台。

![2](../../images/1.0.x/developer/uds/uds_login.png)
...
![](../../images/1.0.x/developer/uds/dashboard.png)

![](../../images/1.0.x/developer/uds/dashboard1.png)

用户可通过顶部提供的工具进行时间、项目的筛选，便于快速查看整体情况，如下图所示：

![](../../images/1.0.x/developer/uds/项目筛选.png)
...
![](../../images/1.0.x/developer/uds/创建项目.png)
...
![](../../images/1.0.x/developer/uds/进入项目.png)
...
![](../../images/1.0.x/developer/uds/创建工作流1.png)

![](../../images/1.0.x/developer/uds/创建工作流2.png)
...
![](../../images/1.0.x/developer/uds/添加任务.png)

##### 3.3.1.2 数据集成任务

将工具栏中的数据集成组件（DI）拖入到画布中，双击进入编辑页面

![](../../images/1.0.x/developer/uds/数据集成任务1.png)

左侧节点设置栏可以设置数据集成节点的基本信息，切换至集成组件tab，可将数据集成的来源数据源、转置组件和目标数据源拖拽至画布中。

![](../../images/1.0.x/developer/uds/数据集成任务2.png)

使用连线工具，将来源、转置和目标组件连接起来。

![](../../images/1.0.x/developer/uds/数据集成任务3.png)

双击任意组件，可打开编辑页面

![](../../images/1.0.x/developer/uds/数据集成任务4.png)

##### 3.3.1.2 其他任务

其余类型任务可以直接在右侧填写节点信息

![](../../images/1.0.x/developer/uds/其他任务.png)
...
![](../../images/1.0.x/developer/uds/删除任务.png)
...
![](../../images/1.0.x/developer/uds/添加任务顺序.png)



#### 3.3.3 删除依赖关系

点击左上角 “选中”<img src="../../images/1.0.x/developer/uds/选中icon.png" style="zoom:48%;" /> 图标，选中连接线，点击右上角 "删除"<img src="../../images/1.0.x/developer/uds/删除icon.png" style="zoom:48%;" />图标，删除任务间的依赖关系。

![](../../images/1.0.x/developer/uds/删除依赖关系.png)



### 3.4 保存工作流

点击左上工具栏的“保存” <img src="../../images/1.0.x/developer/uds/保存icon.png" style="zoom:48%;" />图标，然后填写名称、描述等信息

![](../../images/1.0.x/developer/uds/保存工作流1.png)

![](../../images/1.0.x/developer/uds/保存工作流2.png)
...
![](../../images/1.0.x/developer/uds/运行工作流.png)
...
![](../../images/1.0.x/developer/uds/工作流实例.png)
...
![](../../images/1.0.x/developer/uds/任务实例.png)
...
![](../../images/1.0.x/developer/uds/任务日志.png)
...
![](../../images/1.0.x/developer/uds/新建数据源1.png)

![](../../images/1.0.x/developer/uds/新建数据源2.png)
...
![](../../images/1.0.x/developer/uds/上传文件1.png)

填写文件名称和描述，选择是否是UDF资源，UDF资源是新建UDF函数时所需的资源。

![](../../images/1.0.x/developer/uds/上传文件2.png)
...
![](../../images/1.0.x/developer/uds/新建UDF函数1.png)

填写函数名称、描述、包名类名，选择UDF资源，UDF资源需提前上传。

![](../../images/1.0.x/developer/uds/新建UDF函数2.png)

新建好的UDF函数可以在HIVE的SQL查询中使用

![](../../images/1.0.x/developer/uds/新建UDF函数3.png)
...
![](../../images/1.0.x/developer/uds/新建用户1.png)

![](../../images/1.0.x/developer/uds/新建用户2.png)

#### 5.1.2 授权项目

点击“授权项目”，从现有的项目中选择项目授权给该用户，只有拥有项目权限的用户才能进入该项目进行创建工作等操作。

![](../../images/1.0.x/developer/uds/授权项目1.png)

![](../../images/1.0.x/developer/uds/授权项目2.png)
...
![](../../images/1.0.x/developer/uds/授权数据源.png)
...
![](../../images/1.0.x/developer/uds/授权文件.png)
...
![](../../images/1.0.x/developer/uds/授权UDF资源.png)
...
![](../../images/1.0.x/developer/uds/新建告警组1.png)

![](../../images/1.0.x/developer/uds/新建告警组2.png)

添加好的告警组可以在运行工作流的参数弹窗中选择

![](../../images/1.0.x/developer/uds/新建告警组3.png)