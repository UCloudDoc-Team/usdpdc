...
告警模板与USDP集群绑定，及可对该集群实施监控，当触发监控规则是，即及时向 [通知组](usdpdc/1.0.x/webconsole/alarmInform_group) 中的各个 [通知对象](usdpdc/1.0.x/webconsole/alarmInform_object) 发送告警信息。
...
- [模板监控指标管理](usdpdc/1.0.x/webconsole/alarmTemplate?id=_1-模板监控指标管理)
- [告警模板快速绑定集群并生效](usdpdc/1.0.x/webconsole/alarmTemplate?id=_2-告警模板快速绑定集群并生效)
- [新建告警模板](usdpdc/1.0.x/webconsole/alarmTemplate?id=_3-新建告警模板)
- [删除告警模板](usdpdc/1.0.x/webconsole/alarmTemplate?id=_4-删除告警模板)
...
关于自定义告警模板，参见 [新建告警模板](usdpdc/1.0.x/webconsole/alarmTemplate?id=_3-新建告警模板) 。
