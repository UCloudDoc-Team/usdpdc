...
USDP支持通知组管理的能力，结合通知组与 [告警模板](usdpdc/1.0.x/webconsole/alarmTemplate)  “监控指标”的绑定，实现监控规则触发时，即使将告警信息发送给绑定的通知组中的 [通知对象](usdpdc/1.0.x/webconsole/alarmInform_object) 。接下来将介绍通知组的的管理和维护的方法。
