...
![](../images/webconsole/service/service_yarn.png)
...
![](../images/webconsole/service/service_yarn_details.png)
...
![](../images/webconsole/service/storage_zk.png)
...
![](../images/webconsole/service/storage_zk_details.png)

控制台监控指标可视化支持按时间进行查看，USDP预置了一些时间周期（默认为“1小时内”，还有“6小时内”、“12小时内”、“1天内”、“7天内”、“15天内”、“30天内”），也支持时间周期“自定义”，如下图所示：

![](../images/webconsole/service/storage_zk_details_time.png)
...
![](../images/webconsole/service/storage_zk_subpart_add.png)

点击“新增组件”按钮，进入“新增组件或服务”向导，如下图所示：

![](../images/webconsole/service/storage_zk_subpart_add_guide1.png)

选择QuarumPeermain组件需要扩展的节点主机，如下对话框截图所示：

![](../images/webconsole/service/storage_zk_subpart_add_guide2.png)

管理平台检测出，已加入该平台的所有节点主机中，udp02节点上暂未运行QuarumPeermain组件，“勾选”udp02左侧的复选框，点击“确定”按钮，进入“部署信息总览”向导页，如下图所示：

![](../images/webconsole/service/storage_zk_subpart_add_guide3.png)

经浏览确认无误，点击“开始部署”按钮，管理平台将为udp02节点安全QuarumPeermain组件，安装无误，将显示安装成功状态，平台会自动启动该组件，如下图所示：

![](../images/webconsole/service/storage_zk_subpart_add_guide4.png)

安装进度完成后，点击“完成”按钮。如下图所示：

![](../images/webconsole/service/storage_zk_subpart_add_guide5.png)
...
![](../images/webconsole/service/storage_hdfs.png)
...
![](../images/webconsole/service/storage_hdfs_details.png)

对HDFS GC相关监控（GC5分钟内的频率、GC耗时、GC MarkSweep标记耗时、GC MarkSweep 5分钟标记频率）如下图所示：

![](../images/webconsole/service/storage_hdfs_details1.png)

对HDFS “堆内存使用大小”的监控，如下图所示：

![](../images/webconsole/service/storage_hdfs_details2.png)
...
![](../images/webconsole/service/storage_hdfs_ui.png)

点击“[udp08] NameNode1 Web UI”/“[udp09] NameNode2 Web UI”，会自动在浏览器中打开新的标签页，并显示udp08/udp09节点上的HDFS管理页面，如下图所示：

![](../images/webconsole/service/storage_hdfs_ui_details.png)
...
![](../images/webconsole/service/service_prometheus.png)
...
![](../images/webconsole/service/service_prometheus_details.png)

![](../images/webconsole/service/service_prometheus_details1.png)
...
![](../images/webconsole/service/service_grafana.png)
...
![](../images/webconsole/service/service_grafana_details.png)
...
![](../images/webconsole/service/service_grafana_ui.png)

点击“[udp08] Grafana Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的Grafana管理页面，如下图所示：

![](../images/webconsole/service/service_grafana_ui_details.png)
...
![](../images/webconsole/service/service_zkui.png)
...
![](../images/webconsole/service/service_zkui_details.png)
...
![](../images/webconsole/service/service_zkui_ui.png)

点击“[udp08] ZKUI Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的ZKUI登陆管理页面，如下图所示：

![](../images/webconsole/service/service_zkui_ui_details.png)
...
![](../images/webconsole/service/service_configer_zk_update.png)

- 在选择节点对话框中勾选好节点后，点击 <kbd>修改配置</kbd> 按钮进入配置修改页面，如下图所示：

![](../images/webconsole/service/service_configer_zk_update1.png)
...
![](../images/webconsole/service/service_configer_zk_update1_group2.png)

![](../images/webconsole/service/service_configer_zk_update1_group3.png)
...
![](../images/webconsole/service/service_configer_zk_update1_group.png)

图解：将“Log4j.properties”的四个节点的其中两个单独创建一个新分组。

- 此时，分组变为两个，且分组2中包含的节点即为上一步操作选择的两个节点，如下图所示：

![](../images/webconsole/service/service_configer_zk_update1_group0.png)

![](../images/webconsole/service/service_configer_zk_update1_group1.png)
...
![](../images/webconsole/service/service_configer_yarn_update.png)

此时，左侧导航菜单处“YARN”服务后侧出现橙色叹号警示，提醒您执行服务重启生效。且YARN服务“组件管理”中亦有详细提示，如下图所示：

![](../images/webconsole/service/service_configer_yarn_reboot.png)
