...
USDP支持多集群管理，可前往参考 [新增大数据集群](usdpdc/2.0.x/plan&create/first_create)。
...
![img](../../images/2.0.x/guide/node/20210120pm125238.png)



进入向导，用户可根据计划，将需要添加到当前集群的新节点的完全限定域名进行补充填写，并确认SSH的用户名及端口号。如下图所示：

![img](../../images/2.0.x/guide/node/20210120pm125331.png)
