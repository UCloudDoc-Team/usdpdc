...
![img](../../images/2.0.x/guide/alarm/set_emailserver/notify_usdp_entrance.png)

- 进入 “通知方式管理” 页面时，点击 “邮件发送设置” 选项卡，系统提示 “尚未配置邮件发送服务器及账号”，如下图所示：

![img](../../images/2.0.x/guide/alarm/set_emailserver/notify_usdp_set_email.png)
...
![img](../../images/2.0.x/guide/alarm/set_emailserver/notify_usdp_seting_email.png)

此时，用户可参考如下列表内容，选择合适的 “邮箱类型”、“SMTP服务器地址”、“是否开启SSL”、端口，来完成对话框配置填写：

![img](../../images/2.0.x/guide/alarm/set_emailserver/notify_usdp_set_email_like.png)

- 验证通过后，显示如下（这里是以UCloud邮箱服务器配置为示例）：

![img](../../images/2.0.x/guide/alarm/set_emailserver/notify_usdp_set_email_down.png)
...
![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_set_notifyobject.png)
...
![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_email.png)
...
![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_dingding.png)
...
![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_qiwei.png)
...
![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_api.png)
...
![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_down.png)

若因某通知对象工作变动原因，管理员可能需要删除该通知对象是；此时，勾选该对象左侧的复选框，并点击 <kbd>删除</kbd> 按钮完成，并确认后，完成删除操作，如下图所示：

![img](../../images/2.0.x/guide/alarm/notification_object/notify_usdp_notifyobject_delete.png)
...
![img](../../images/2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup.png)
...
![img](../../images/2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_default.png)
...
![img](../../images/2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_groupadd.png)

添加好 “通知组” 后，如下图所示：

![img](../../images/2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_management.png)
