...
![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_set_notifyobject.png)
...
![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_email.png)
...
![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_dingding.png)
...
![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_qiwei.png)
...
![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_api.png)
...
![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_set_notifyobject_down.png)

若因某通知对象工作变动原因，管理员可能需要删除该通知对象是；此时，勾选该对象左侧的复选框，并点击 <kbd>删除</kbd> 按钮完成，并确认后，完成删除操作，如下图所示：

![img](../../images/2.1.x/guide/alarm/notification_object/notify_usdp_notifyobject_delete.png)
...
![img](../../images/2.1.x/guide/alarm/notification_group/notify_usdp_set_notifygroup.png)
...
![img](../../images/2.1.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_default.png)
...
![img](../../images/2.1.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_groupadd.png)

添加好 “通知组” 后，如下图所示：

![img](../../images/2.1.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_management.png)
...
![img](../../images/2.1.x/guide/alarm/set_alarm/set_alarm_entrance.png)

> 初始状态下，新创建的集群并未绑定任何告警模板。

点击 <kbd>绑定告警模板</kbd> 按钮，在弹出的 “绑定告警模板” 对话框中进行绑定操作，如下图所示：

![img](../../images/2.1.x/guide/alarm/set_alarm/set_alarm_set_template.png)
...
![img](../../images/2.1.x/guide/alarm/set_alarm/set_alarm_show.png)
