...
![img](../../images/xc_x86_2.1.x/guide/service/service_yarn.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_yarn_details.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/storage_zk.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/storage_zk_details.png)

控制台监控指标可视化支持按时间进行查看，USDP预置了一些时间周期（默认为“1小时内”，还有“6小时内”、“12小时内”、“1天内”、“7天内”、“15天内”、“30天内”），也支持时间周期“自定义”，如下图所示：

![img](../../images/xc_x86_2.1.x/guide/service/storage_zk_details_time.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/storage_hdfs_ui.png)

点击“[udp08] NameNode1 Web UI”/“[udp09] NameNode2 Web UI”，会自动在浏览器中打开新的标签页，并显示udp08/udp09节点上的HDFS管理页面，如下图所示：

![img](../../images/xc_x86_2.1.x/guide/service/storage_hdfs_ui_details.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_prometheus.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_prometheus_details.png)

![img](../../images/xc_x86_2.1.x/guide/service/service_prometheus_details1.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_prometheus_ui.png)

点击“[udp08] Prometheus Graph Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的Prometheus Graph管理页面，如下图所示：

![img](../../images/xc_x86_2.1.x/guide/service/service_prometheus_ui_details.png)

点击“[udp08] Prometheus Targets Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的Prometheus Targets管理页面，如下图所示：

![img](../../images/xc_x86_2.1.x/guide/service/service_prometheus_ui_details1.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_grafana.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_grafana_details.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_grafana_ui.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_zkui.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_zkui_details.png)
...
![img](../../images/xc_x86_2.1.x/guide/service/service_zkui_ui.png)

点击“[udp08] ZKUI Web UI”，会自动在浏览器中打开新的标签页，并显示udp08节点上的ZKUI登陆管理页面，如下图所示：

![img](../../images/xc_x86_2.1.x/guide/service/service_zkui_ui_details.png)
