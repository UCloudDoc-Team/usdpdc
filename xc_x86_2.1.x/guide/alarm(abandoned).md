...
![img](../../images/xc_x86_2.1.x/guide/alarm/set_emailserver/notify_usdp_set_email.png)
...
![img](../../images/xc_x86_2.1.x/guide/alarm/set_emailserver/notify_usdp_seting_email.png)

此时，用户可参考如下列表内容，选择合适的 “邮箱类型”、“SMTP服务器地址”、“是否开启SSL”、端口，来完成对话框配置填写：

![img](../../images/xc_x86_2.1.x/guide/alarm/set_emailserver/notify_usdp_set_email_like.png)

- 验证通过后，显示如下（这里是以UCloud邮箱服务器配置为示例）：

![img](../../images/xc_x86_2.1.x/guide/alarm/set_emailserver/notify_usdp_set_email_down.png)
