...
![img](../../images/xc_x86_2.1.x/guide/node/node_usdp_nodemanager.png)
...
![img](../../images/xc_x86_2.1.x/guide/node/usdp_console_node_component_count.png)

点击统计数字，即可在弹出的对话框中查看到该接节点上所有已部署的组件及组件运行状态，方便集中的、滚动查看。如下图所示：

![img](../../images/xc_x86_2.1.x/guide/node/usdp_console_node_component_show.png)
...
![img](../../images/xc_x86_2.1.x/guide/node/usdp_console_node_single_entrance.png)

在节点“概览”页面，已针对当前节点的系统监控指标实现图表展示，如下图所示：

![img](../../images/xc_x86_2.1.x/guide/node/usdp_console_node_single_details.png)
...
![img](../../images/xc_x86_2.1.x/guide/node/usdp_console_node_component_management.png)
