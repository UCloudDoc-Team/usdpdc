...
![](../../images/xc_x86_2.1.x/developer/atlas/usdp_atlas.png)

![](../../images/xc_x86_2.1.x/developer/atlas/atlas_login.png)

Atlas管理员账号，操作指南-[各服务Web UIs账号](usdpdc/xc_x86_2.1.x/cluster_notes/login)文档

### 2. Atlas Web UI首页

![](../../images/xc_x86_2.1.x/developer/atlas/16073970384716.png)
...
![](../../images/xc_x86_2.1.x/developer/atlas/1607398637701.png)

### 5. Hive 元数据 Lineage 查看
Atlas WebUI 搜索到某个表后，可以看到这个表的  Lineage，如上面创建的 t_udp_service_component_mapping_old。

![](../../images/xc_x86_2.1.x/developer/atlas/16073989954242.png)