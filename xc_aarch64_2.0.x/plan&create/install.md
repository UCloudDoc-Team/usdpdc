...
欢迎使用 USDP 构建大数据平台，接下来，我们将通过几个简单的步骤，完成 **USDP Arm_2.0.x** 管理服务的部署流程，从而能够通过 Web 页面的方式，快速部署各类大数据服务与组件。
...
?> **提示：**</br>- 对your.properties 文件中各IP地址的填写，建议参考 [资源规划](usdpdc/xc_aarch64_2.0.x/plan&create/deploy_plan) 说明后，按实际需求规划进行填写。
...
![](../../images/xc_aarch64_2.0.x/plan&create/install/login.png)
...
?> **提示：**</br>- License 是一个 `xxx.tar.gz` 的文件，无需解压，直接导入即可。</br></br>关于更多 “许可证” 的内容，请前往 [USDP许可证管理](usdpdc/xc_aarch64_2.0.x/license/license) 查看。
...
至此，环境初始化及USDP管理服务的安装已完成，接下来将 [通过USDP创建第一个大数据集群](usdpdc/xc_aarch64_2.0.x/plan&create/first_create)。
