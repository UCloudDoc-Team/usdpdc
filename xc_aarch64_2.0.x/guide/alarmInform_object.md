...
通知对象，是USDP系统中，告警信息发送的目标用户，通知对象是由 [通知组](usdpdc/xc_aarch64_2.0.x/guide/alarmInform_group)  进行管理的；通知组再与 [告警模板](usdpdc/xc_aarch64_2.0.x/guide/alarmTemplate) 中的监控指标关联。
