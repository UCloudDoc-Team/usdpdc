...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_emailserver/notify_usdp_set_email.png)
...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_emailserver/notify_usdp_seting_email.png)

此时，用户可参考如下列表内容，选择合适的 “邮箱类型”、“SMTP服务器地址”、“是否开启SSL”、端口，来完成对话框配置填写：

![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_emailserver/notify_usdp_set_email_like.png)

- 验证通过后，显示如下（这里是以UCloud邮箱服务器配置为示例）：

![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_emailserver/notify_usdp_set_email_down.png)
...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup.png)
...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_default.png)
...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_groupadd.png)

添加好 “通知组” 后，如下图所示：

![img](../../images/xc_aarch64_2.0.x/guide/alarm/notification_group/notify_usdp_set_notifygroup_management.png)
...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_alarm/set_alarm_entrance.png)

> 初始状态下，新创建的集群并未绑定任何告警模板。

点击 <kbd>绑定告警模板</kbd> 按钮，在弹出的 “绑定告警模板” 对话框中进行绑定操作，如下图所示：

![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_alarm/set_alarm_set_template.png)
...
![img](../../images/xc_aarch64_2.0.x/guide/alarm/set_alarm/set_alarm_show.png)
