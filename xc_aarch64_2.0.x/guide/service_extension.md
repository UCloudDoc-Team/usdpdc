...
- 切换方式，可参考 [集群切换](usdpdc/xc_aarch64_2.0.x/clusters/clusters?id=_2-集群切换) 操作。
...
![img](../../images/xc_aarch64_2.0.x/guide/service/service_add_step5.png)

USDP管理服务将自动生成Sqoop服务部署任务，将在被选择的节点上安装SqoopClient组件，如下图所示：

![img](../../images/xc_aarch64_2.0.x/guide/service/service_add_step6.png)
